class Debug{
    ...
    [void] showGpuInformation(){
        ...
        Write-Host "----------------------------------------------------" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "Description: $($gpu.Description)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "Caption: $($gpu.Caption)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "Name; $($gpu.Name)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "Status: $($gpu.Status)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "Availability: $($gpu.Availability)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "Config Manager User Config: $($gpu.ConfigManagerUserConfig)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "Creation Class Name: $($gpu.CreationClassName)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "Device ID: $($gpu.DeviceID)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "Error Cleared: $($gpu.ErrorCleared)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "Error Description: $($gpu.ErrorDescription)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "Last Error Code: $($gpu.LastErrorCode)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "PNP Device ID: $($gpu.PNPDeviceID)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "Power Management Capabilities: $($gpu.PowerManagementCapabilities)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "Power Management Supported: $($gpu.PowerManagementSupported)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "Status Info: $($gpu.StatusInfo)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "System Creation Class Name: $($gpu.SystemCreationClassName)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "System Name: $($gpu.SystemName)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "Max Number Controlled: $($gpu.MaxNumberControlled)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "PNP Device ID: $($gpu.PNPDeviceID)" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "----------------------------------------------------" -BackgroundColor Green -ForegroundColor Black;
        Write-Host "";
        Write-Host "Actions:                                            " -BackgroundColor Green -ForeGroundColor Black;
